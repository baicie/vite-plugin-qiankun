...
>
> fock自vite-plugin-qiankun 做了一点简单改造以匹配react开发环境
...
```typescript
// main.ts
import { renderWithQiankun, qiankunWindow } from '@baicie/vite-plugin-qiankun/dist/helper';
...
```typescript
import { qiankunWindow } from '@baicie/vite-plugin-qiankun/dist/helper';
